...
urlpatterns = [
    ...
    path("client_action_submit/<int:client_id>/", views.client_action_submit, name="client_action_submit"),
    path("close_client_action_submit/<int:customer_id>/", views.close_client_action_submit, name="close_client_action_submit"),
    path("na_client_action_submit/<int:client_id>/", views.na_client_action_submit, name="na_client_action_submit"),
    path("lm_client_action_submit/<int:client_id>/", views.lm_client_action_submit, name="lm_client_action_submit"),
    ...
    path('remove_campaign/<int:campaign_id>/<int:client_id>',views.remove_campaign,name='remove_campaign'),
    path('remove_product/<int:product_id>/<int:client_id>',views.remove_product,name='remove_product'),
    ...
    path("send_client_email/<int:customer_id>", views.send_client_email, name="send_client_email"),
    ...
    path('add_coverage_areas/<int:client_id>', views.add_coverage_areas, name='add_coverage_areas'),
]